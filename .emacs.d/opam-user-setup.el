...
;; ## added by OPAM user-setup for emacs / tuareg ## fa2329c8ae8ebc75b6f43394e5d7ce79 ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/Users/sclolus/.opam/default/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
